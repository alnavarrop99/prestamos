...
function Basic( { title, description, status, ...props }: VariantProps<typeof alertVariants> & { title: string, description: string, status: "info" | "normal" | "warn" }  ) {
  return  <Alert {...props}>
...
export const _Basic: StoryObj< VariantProps<typeof alertVariants> & { title: string, description: string, status: "info" | "normal" | "warn" }> = {
  name: "Basic",
  args: {
